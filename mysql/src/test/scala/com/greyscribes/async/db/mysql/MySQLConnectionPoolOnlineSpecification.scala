 ...
 */
class MySQLConnectionPoolOnlineSpecification extends Specification with Mockito with ExecutionEnvironment {
	def is(implicit ee: ExecutionEnv) = {

		"The MySQLConnectionPool with a real database" should {
